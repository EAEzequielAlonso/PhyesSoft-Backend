...
export class BrandRepository {
    ...
    async getBrandById (id:string): Promise<Brand> {
        return this.brandRepository.findOne({where: {id}, relations: {models:true}});
    }
    ...
    async deleteBrand (id:string): Promise<DeleteResult> {
        try {
            ...
            throw new ConflictException ("Actualmente la marca fue utilizada. No se puede eliminar  ya que generaria errores. puede probar modificando la marca si lo cree necesario");
        }
    }   
